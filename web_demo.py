...
def create_demo_interface():
    ...
    # Create interface
    with gr.Blocks(title="QLORAX Fine-tuned Model Demo", theme=gr.themes.Soft()) as interface:
        gr.Markdown("""
        ...
        **Welcome to your fine-tuned language model!** This model has been trained on machine learning Q&A data using QLoRA (Quantized Low-Rank Adaptation).
        ...
        with gr.Row():
            with gr.Column(scale=3):
                chatbot = gr.Chatbot(
                    label="Chat with your fine-tuned model",
                    height=400,
                    show_label=True
                )
                ...
                with gr.Row():
                    ...
                    stats = gr.Textbox(label="Generation Stats", scale=3, interactive=False)
